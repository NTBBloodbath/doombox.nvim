...
theme.setup = function(config)
  ...
  groups.base = {
    ...
    PmenuSel = { fg = cb.fg_alt, bg = cb.bg_popup },
    PmenuSelBold = { fg = cb.fg_alt, bg = cb.bg_popup, style = "bold" },
  ...
  groups.lsp = {
    ...
    DiagnosticFloatingWarning = { link = "WarningMsg" },
    DiagnosticFloatingInformation = { link = "MoreMsg" },
    DiagnosticDefaultHint = { link = "Msg" },
    DiagnosticDefaultError = { link = "ErrorMsg" },
    DiagnosticDefaultWarning = { link = "WarningMsg" },
    DiagnosticDefaultInformation = { link = "MoreMsg" },
    DiagnosticVirtualTextHint = { link = "Msg" },
    DiagnosticVirtualTextError = { link = "ErrorMsg" },
    DiagnosticVirtualTextWarning = { link = "WarningMsg" },
    DiagnosticVirtualTextInformation = { link = "MoreMsg" },
    DiagnosticUnderlineHint = { link = "MsgUnderline" },
    DiagnosticUnderlineError = { link = "ErrorMsgUnderline" },
    DiagnosticUnderlineWarning = { link = "WarningMsgUnderline" },
    DiagnosticUnderlineInformation = { link = "MoreMsgUnderline" },
